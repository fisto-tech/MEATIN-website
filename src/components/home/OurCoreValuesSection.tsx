...
export const OurCoreValuesSection: React.FC = () => {
  return (
    <section className="relative w-full bg-[#FBF3E9] py-12 sm:py-16 lg:py-[3vw] lg:min-h-screen lg:h-screen lg:flex lg:flex-col lg:justify-between overflow-hidden z-10">
      <div className="w-full max-w-[1536px] lg:max-w-[95vw] mx-auto px-4 sm:px-6 lg:px-[2vw] flex-1 flex flex-col justify-between">
        ...
        <div className="text-center max-w-3xl mx-auto mb-6">
          ...
          <div className="flex flex-col items-center mb-1.5">
            ...
            <span className="h-[2px] lg:h-[0.14vw] w-8 lg:w-[2.5vw] bg-[#D4A437] mt-1 rounded-full" />
          </div>

          {/* Main Title */}
          <h2 className="text-3xl sm:text-4xl lg:text-[3.2vw] leading-tight mt-1">
        ...
        {/* ========================================================================= */}
        <div className="w-full max-w-[1400px] lg:max-w-[77vw] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-[2vw] mb-10 lg:mb-[2vw]">
          {coreValues.map((card) => {
            return (
              <div
                key={card.title}
                className="group relative w-full max-w-[340px] lg:max-w-[19.5vw] mx-auto rounded-3xl lg:rounded-[1.5vw] p-6 lg:p-[1.8vw] transition-all duration-300 flex flex-col items-center justify-center text-center bg-[#FAF6F0] hover:bg-[#153520] border border-[#EADBCC] hover:border-[#153520] shadow-sm hover:shadow-2xl hover:-translate-y-2 cursor-pointer"
              >
                {/* Circle Icon Badge */}
                <div className="w-16 h-16 lg:w-[6.2vw] lg:h-[6.2vw] rounded-full flex items-center justify-center mb-5 lg:mb-[1.3vw] transition-colors duration-300 p-2 text-[#13321B] group-hover:text-white">
                  {card.renderIcon()}
                </div>

                {/* Accent Underline & Dot beneath Icon */}
                <div className="flex items-center justify-center gap-1 w-12 lg:w-[3vw] mb-4 lg:mb-[1.1vw]">
                  <span className="h-[1.5px] lg:h-[0.1vw] flex-1 bg-[#D4A437]" />
                  <span className="w-1 h-1 lg:w-[0.3vw] lg:h-[0.3vw] rounded-full bg-[#D4A437]" />
                  <span className="h-[1.5px] lg:h-[0.1vw] flex-1 bg-[#D4A437]" />
                </div>

                {/* Card Title - DM Serif Display */}
                <h3 className="font-dm-serif text-2xl sm:text-3xl lg:text-[2.1vw] leading-tight mb-3 lg:mb-[0.8vw] text-[#153520] group-hover:text-white transition-colors duration-300">
                  {card.title}
                </h3>
        ...
        {/* ========================================================================= */}
        <div className="pt-4 lg:pt-[1vw] flex flex-col items-center">
          
          {/* Tagline: Quality you can trust. Lotus Freshness you can taste. */}
          <div className="font-dm-serif text-xl sm:text-2xl lg:text-[1.6vw] text-[#153520] flex items-center justify-center gap-2 sm:gap-3 mb-6 lg:mb-[1.5vw] flex-wrap text-center">
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-8 lg:gap-[3vw] flex-wrap">
            {bottomFeatures.map((feat, idx) => (
              <React.Fragment key={feat.title}>
                {idx > 0 && (
                  <span className="hidden sm:block h-8 lg:h-[2vw] w-[1.5px] bg-[#D4A437]/50" />
                )}
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="w-11 h-11 sm:w-14 sm:h-14 lg:w-[3.4vw] lg:h-[3.4vw] rounded-full bg-[#EFE4D4] flex items-center justify-center p-2.5 sm:p-3 lg:p-[0.7vw] text-[#153520] shadow-sm">
                    {feat.renderBadge()}
                  </div>
                  <span className="font-manrope font-extrabold text-sm sm:text-base lg:text-[1.1vw] text-[#153520] tracking-tight">
                    {feat.title}
                  </span>
                </div>
              </React.Fragment>
